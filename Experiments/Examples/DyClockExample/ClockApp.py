...
class FM(FeatureManager):
    def setupFeatures(self):
        from Experiments.Examples.DyClockExample.Features.IntegratedClock import IntegratedClock
        from Experiments.Examples.DyClockExample.Features.VisualClock import VisualClock
