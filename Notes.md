...
__Solutions__
1. Create a port for each thread and sent the print commands to the right port. Take a look if there is a builtin solution with the command line for that.
