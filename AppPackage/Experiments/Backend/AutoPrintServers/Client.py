...
from AppPackage.Experiments.Backend.AutoPrintServers.Commands import AutoPrintServerCommands
from AppPackage.Experiments.Backend.AutoPrintServers.SocketManagers import ClientConnectivityManager
...
class AutoPrintDesktopClient(object):
    ...
    def sendCommand(cls, cmd: str, *args, ignore_response=False):
        cls.__sendCommand(cls.connManager._packMessage(cmd, *args))
